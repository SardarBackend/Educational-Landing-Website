				...
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="demoMenu">
							...
							<li> <a class="dropdown-item active" href="index-6.html">نسخه 5</a></li>
...
<!-- =======================
Page Banner START -->
<section class="bg-dark align-items-center d-flex" style="background:url(courses/assets/images/pattern/04.png) no-repeat center center; background-size:cover;">
	<!-- Main banner background image -->
	<div class="container">
		<div class="row">
			<div class="col-12">
				<!-- Title -->
				<h1 class="text-white fs-2">لیست نسخه 3</h1>
				<!-- Breadcrumb -->
				<div class="d-flex">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
							<li class="breadcrumb-item"><a href="#">صفحه اصلی</a></li>
							<li class="breadcrumb-item active" aria-current="page">لیست نسخه 3</li>
						</ol>
					</nav>
				</div>
			</div>
...
<section class="pb-0 py-sm-5">
	<div class="container">
		...
		<div class="row g-3 align-items-center mb-4">
			<!-- Content -->
			<div class="col-md-4">
				<h4 class="mb-0 fs-5 fw-normal">نمایش 1-7 از 32 نتیجه</h4>
			</div>
			...
			<div class="col-lg-3 col-xxl-4">
				...
				<div class="offcanvas-xl offcanvas-end" tabindex="-1" id="offcanvasSidebar">
					...
					<div class="offcanvas-body p-3 p-xl-0">
						<form>
							...
							<div class="card card-body shadow p-4 mb-4">
								<!-- Title -->
								<h4 class="mb-4 fs-6">فیلتر دسته بندی</h4>
									<div class="row">
										<!-- Category group -->
										<div class="col-xxl-6">
											<!-- Checkbox -->
											...
											<div class="form-check">
												...
												<label class="form-check-label" for="flexCheckDefault11">شبکه</label>
											</div>
											<!-- Checkbox -->
											<div class="form-check">
											...
											<div class="form-check">
												...
												<label class="form-check-label" for="flexCheckDefault17">هنر</label>
											</div>
										</div>
										...
										<div class="col-xxl-6">
											...
											<div class="form-check">
												...
												<label class="form-check-label" for="flexCheckDefault13">مالی</label>
											</div>
											<!-- Checkbox -->
											<div class="form-check">
												<input class="form-check-input" type="checkbox" value="" id="flexCheckDefault14">
												<label class="form-check-label" for="flexCheckDefault14">برنامه نویسی</label>
											</div>
											<!-- Checkbox -->
											<div class="form-check">
											...
											<div class="form-check">
												...
												<label class="form-check-label" for="flexCheckDefault16">نوشتاری</label>
											</div>
											<!-- Checkbox -->
											<div class="form-check">
												<input class="form-check-input" type="checkbox" value="" id="flexCheckDefault18">
												<label class="form-check-label" for="flexCheckDefault18">مارکتینگ</label>
											</div>
										</div>
									</div><!-- Row END -->
							</div>
							...
							{{-- <div class="card card-body shadow p-4 mb-4">
								...
								<ul class="list-inline mb-0 g-3">
									...
									<li class="list-inline-item mb-2">
										...
										<label class="btn btn-light btn-primary-soft-check" for="btn-check-2">انگلیس</label>
									</li>
									<!-- Item -->
									<li class="list-inline-item mb-2">
					...
					<div class="d-grid p-2 p-xl-0 bg-body text-center">
						<button class="btn btn-primary mb-0">فیلتر</button>
					</div>
				</div>
