						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
									<div>
										<h5 class="card-title mb-0"><a href="#">{{ $teacher->name }} </a></h5>
										<p class="small mb-2 mb-sm-0">  {{ $teacher->job }}</p>
									</div>
									<span class="h6 fw-light">4.3<i class="fas fa-star text-warning ms-1"></i></span>
								</div>
								<!-- Content -->
								<p class="text-truncate-2 mb-3">{{ $teacher->bio }}</p>
								<!-- Info -->
								<div class="d-sm-flex justify-content-sm-between align-items-center">
									<!-- Title -->
									<h6 class="text-orange mb-0 fw-normal"> {{ $teacher->Profession }}</h6>
