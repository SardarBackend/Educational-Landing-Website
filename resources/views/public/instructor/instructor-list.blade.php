	...
	<div class="container">
		...
		<div class="row mb-4 align-items-center">
			...
			<div class="col-sm-6 col-xl-4">
				<form class="border rounded p-2">
					<div class="input-group input-borderless">
						<input class="form-control me-1" type="search" placeholder="جستجوی مدرس">
			...
			<div class="col-sm-6 col-xl-2 mt-3 mt-xl-0 d-grid">
				<a href="#" class="btn btn-lg btn-primary mb-0">فیلتر</a>
			</div>
		</div>
		<!-- Search option END -->
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
									<div>
										<h5 class="card-title mb-0"><a href="#">میلاد ناصری</a></h5>
										<p class="small mb-2 mb-sm-0">مدرس دانشگاه تهران</p>
									</div>
									<span class="h6 fw-light">4.3<i class="fas fa-star text-warning ms-1"></i></span>
								</div>
								<!-- Content -->
								<p class="text-truncate-2 mb-3">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
								<!-- Info -->
								<div class="d-sm-flex justify-content-sm-between align-items-center">
									<!-- Title -->
									<h6 class="text-orange mb-0 fw-normal">دیجیتال مارکتنیگ</h6>
					...
					<div class="row g-0">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
									<div>
										<h5 class="card-title mb-0"><a href="#">لیلا مرادی</a></h5>
										<p class="small mb-2 mb-sm-0">مدرس دانشگاه آزاد</p>
									</div>
								...
								<div class="d-sm-flex justify-content-sm-between align-items-center">
									<!-- Title -->
									<h6 class="text-orange mb-0 fw-normal">طراح گرافیک</h6>
					...
					<div class="row g-0">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
									<div>
										<h5 class="card-title mb-0"><a href="#">سعید محمدی</a></h5>
								...
								<div class="d-sm-flex justify-content-sm-between align-items-center">
									<!-- Title -->
									<h6 class="text-orange mb-0 fw-normal">مهندس فیزیک</h6>
					...
					<div class="row g-0">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
									<div>
										<h5 class="card-title mb-0"><a href="#">سارا تقی زاده</a></h5>
										<p class="small mb-2 mb-sm-0">مدرس دانشگاه امیرکبیر</p>
									</div>
					...
					<div class="row g-0">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
									<div>
										<h5 class="card-title mb-0"><a href="#">نیلوفر علیزاده</a></h5>
										<p class="small mb-2 mb-sm-0">مدرس دانشگاه پیام نور</p>
									</div>
								...
								<div class="d-sm-flex justify-content-sm-between align-items-center">
									<!-- Title -->
									<h6 class="text-orange mb-0 fw-normal">طراح وب</h6>
					...
					<div class="row g-0">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
									<div>
										<h5 class="card-title mb-0"><a href="#">شیما حسینی</a></h5>
										<p class="small mb-2 mb-sm-0">مدرس دانشگاه تهران</p>
									</div>
								...
								<div class="d-sm-flex justify-content-sm-between align-items-center">
									<!-- Title -->
									<h6 class="text-orange mb-0 fw-normal">مهندس عمران</h6>
					...
					<div class="row g-0">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
									<div>
										<h5 class="card-title mb-0"><a href="#">سهراب حجازی</a></h5>
										<p class="small mb-2 mb-sm-0">مدرس دانشگاه شریف</p>
									</div>
									<span class="h6 fw-light">4.5<i class="fas fa-star text-warning ms-1"></i></span>
								</div>
					...
					<div class="row g-0">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
									<div>
										<h5 class="card-title mb-0"><a href="#">فاطمه افخمی</a></h5>
										<p class="small mb-2 mb-sm-0">مدرس دانشگاه امیرکبیر</p>
									</div>
				...
				<div class="col-11 position-relative">
					<div class="row align-items-center">
						...
						<div class="col-lg-7">
							...
							<p class="text-white mb-3 mb-lg-0">در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.</p>
						</div>
						<!-- Button -->
