							...
							<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="mb-0 ms-2">
													...
													<!-- Info -->
													<div class="d-sm-flex">
														<p class="h6 fw-light mb-0 small me-3"><i class="fas fa-table text-orange me-2"></i>18 ویدیو</p>
														<p class="h6 fw-light mb-0 small"><i class="fas fa-check-circle text-success me-2"></i>6 تکمیل</p>
													</div>
												</div>
											</div>
										</td>
										...
										<!-- Status item -->
										<td>
											<div class="badge bg-success bg-opacity-10 text-success">زنده</div>
										</td>
										<!-- Price item -->
										<td>180,000 تومان</td>
										<!-- Action item -->
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="mb-0 ms-2">
													<!-- Title -->
													<h6 class="fw-normal"><a href="#">دوره جامع آموزش Bootstrap</a></h6>
													<!-- Info -->
													<div class="d-sm-flex">
														<p class="h6 fw-light mb-0 small me-3"><i class="fas fa-table text-orange me-2"></i>0 ویدیو</p>
														<p class="h6 fw-light mb-0 small"><i class="fas fa-check-circle text-success me-2"></i>0 تکمیل</p>
													</div>
												</div>
											</div>
										</td>
										...
										<!-- Status item -->
										<td>
											<div class="badge bg-secondary bg-opacity-10 text-secondary">غیرفعال</div>
										</td>
										<!-- Price item -->
										<td>490,000 تومان</td>
										<!-- Action item -->
												...
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="mb-0 ms-2">
															...
															<!-- Info -->
															<div class="d-sm-flex">
																<p class="h6 fw-light mb-0 small me-3"><i class="fas fa-table text-orange me-2"></i>37 ویدیو</p>
																<p class="h6 fw-light mb-0 small"><i class="fas fa-check-circle text-success me-2"></i>20 تکمیل</p>
															</div>
														</div>
													</div>
												</td>
