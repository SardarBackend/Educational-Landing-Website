...
<head>
	...
	<link rel="stylesheet" type="text/css" href="courses/assets/vendor/plyr/plyr.css" />
								...
								<div class="accordion-item mb-3">
									<h6 class="accordion-header font-base" id="heading-1">
										<a class="accordion-button fw-bold rounded collapsed d-block" href="#collapse-1" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
											<span class="mb-0">معرفی دوره فتوشاپ</span> 
											<span class="small d-block mt-1">(3 ویدیو)</span> 
										</a>
									</h6>
										...
										<div class="accordion-body mt-3">
											<div class="vstack gap-3">
												...
												<div class="overflow-hidden">
													<div class="d-flex justify-content-between">
														<p class="mb-1">1/3 تکمیل شده</p>
														<h6 class="mb-1 text-end">30%</h6>
													</div>
													<div class="progress progress-sm bg-primary bg-opacity-10">
														<div class="progress-bar bg-primary aos" role="progressbar" data-aos="slide-left" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 30%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
														</div>
													</div>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">معرفی دوره</span>
													</div>
													<p class="mb-0 text-truncate">2دقیقه</p>
												</div>
												...
												<div class="p-2 bg-success bg-opacity-10 rounded-3">
													<div class="d-flex justify-content-between align-items-center">
														<div class="position-relative d-flex align-items-center">
															...
															<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px"> دیجیتال مارکتینگ چیست؟</span>
														</div>
														<p class="mb-0 text-truncate">درحال ضبط</p>
													</div>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">انواع دیجیتال مارکتینگ</span>
													</div>
													<p class="mb-0 text-truncate">18دقیقه</p>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="accordion-item mb-3">
									<h6 class="accordion-header font-base" id="heading-2">
										<a class="accordion-button fw-bold collapsed rounded d-block" href="#collapse-2" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
											<span class="mb-0">آموزش کار به صورت متوسطه</span> 
											<span class="small d-block mt-1">(3 ویدیو)</span> 
										</a>
									</h6>
									<div id="collapse-2" class="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordionExample2">
										...
										<div class="accordion-body mt-3">
											<div class="vstack gap-3">
												...
												<div class="overflow-hidden">
													<div class="d-flex justify-content-between">
														<p class="mb-1">0/3 تکمیل شده</p>
														<h6 class="mb-1 text-end">0%</h6>
													</div>
													<div class="progress progress-sm bg-primary bg-opacity-10">
														<div class="progress-bar bg-primary aos" role="progressbar" data-aos="slide-left" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 0%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
														</div>
													</div>
												</div>
												<!-- Course lecture -->
								...
								<div class="accordion-item mb-3">
									<h6 class="accordion-header font-base" id="heading-5">
										<a class="accordion-button fw-bold collapsed rounded d-block" href="#collapse-5" data-bs-toggle="collapse" data-bs-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
											<span class="mb-0">بهینه سازی موتور جستجو (SEO) چیست؟</span> 
											<span class="small d-block mt-1">(6 ویدیو)</span>
										</a>
									</h6>
											...
											<div class="vstack gap-3">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">مروری بر سئو</span>
													</div>
													<p class="mb-0 text-truncate">15دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">ادیت تصویر مخصوص آتلیه</span>
													</div>
													<p class="mb-0 text-truncate">28دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">شروع طراحی سایت دیجی کالا</span>
													</div>
													<p class="mb-0 text-truncate">38دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">ساخت کارت ویزیت</span>
													</div>
													<p class="mb-0 text-truncate">12دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">برنامه ریزی کلمات کلیدی SEO</span>
													</div>
													<p class="mb-0 text-truncate">35دقیقه</p>
												</div>
											</div>
										</div>
										<!-- Accordion body END -->
								...
								<div class="accordion-item mb-3">
									<h6 class="accordion-header font-base" id="heading-6">
										<a class="accordion-button fw-bold collapsed rounded d-block" href="#collapse-6" data-bs-toggle="collapse" data-bs-target="#collapse-6" aria-expanded="false" aria-controls="collapse-6">
											<span class="mb-0">بازاریابی YouTube</span> 
											<span class="small d-block mt-1">(5 ویدیو)</span>
										</a>
									</h6>
											...
											<div class="vstack gap-3">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">Paint Eyedropper</span>
													</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">ابزار Webmaster</span>
													</div>
													<p class="mb-0 text-truncate">15دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">انتشار مطالب ویژه در YouTube</span>
													</div>
													<p class="mb-0 text-truncate">32دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">توضیح تخصصی ابزار ها(قسمت اول)</span>
													</div>
													<p class="mb-0 text-truncate">20دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">توضیح تخصصی ابزار ها(قسمت دوم)</span>
													</div>
													<p class="mb-0 text-truncate">18دقیقه</p>
												</div>
											</div>
								...
								<div class="accordion-item mb-3">
									<h6 class="accordion-header font-base" id="heading-8">
										<a class="accordion-button fw-bold collapsed rounded d-block" href="#collapse-8" data-bs-toggle="collapse" data-bs-target="#collapse-8" aria-expanded="false" aria-controls="collapse-8">
											<span class="mb-0">سئو چیست؟</span> 
											<span class="small d-block mt-1">(8 ویدیو)</span>
										</a>
									</h6>
											...
											<div class="vstack gap-3">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">روش ساخت پروژه جدید</span>
													</div>
													<p class="mb-0 text-truncate">20دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">توضیح صفحات مختلف فتوشاپ</span>
													</div>
													<p class="mb-0 text-truncate">5دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													...
													<p class="mb-0 text-truncate">16دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													...
													<p class="mb-0 text-truncate">36دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">کلمات کلیدی در وبلاگ و مقالات</span>
													</div>
													<p class="mb-0 text-truncate">15دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">سئوی موبایل</span>
													</div>
													<p class="mb-0 text-truncate">15دقیقه</p>
												</div>
											</div>
								...
								<div class="accordion-item mb-3">
									<h6 class="accordion-header font-base" id="heading-9">
										<a class="accordion-button fw-bold collapsed rounded d-block" href="#collapse-9" data-bs-toggle="collapse" data-bs-target="#collapse-9" aria-expanded="false" aria-controls="collapse-9">
											<span class="mb-0">ذخیره و بازیابی تنظیمات Google</span> 
											<span class="small d-block mt-1">(4 ویدیو)</span>
										</a>
									</h6>
											...
											<div class="vstack gap-3">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">ساخت منوها در بخش مدیریت</span>
													</div>
													<p class="mb-0 text-truncate">20دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">افزودن لینک های تماس</span>
													</div>
													<p class="mb-0 text-truncate">5دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">مرتبه‌های اجرایی و نمادها</span>
													</div>
													<p class="mb-0 text-truncate">16دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">مفهوم آرایه و ذخیره‌سازی</span>
													</div>
													<p class="mb-0 text-truncate">36دقیقه</p>
												</div>
											</div>
								...
								<div class="accordion-item mb-0">
									<h6 class="accordion-header font-base" id="heading-10">
										<a class="accordion-button fw-bold collapsed rounded d-block" href="#collapse-10" data-bs-toggle="collapse" data-bs-target="#collapse-10" aria-expanded="false" aria-controls="collapse-10">
											<span class="mb-0">آموزش امنیت سایت های PHP</span> 
											<span class="small d-block mt-1">(3 ویدیو)</span>
										</a>
									</h6>
											...
											<div class="vstack gap-3">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">ساخت اکانت لینکدین</span>
													</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">جستجوی پیشرفته</span>
													</div>
													<p class="mb-0 text-truncate">31دقیقه</p>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="position-relative d-flex align-items-center">
														...
														<span class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-200px">اپلیکیشن موبایل لینکدین</span>
													</div>
													<p class="mb-0 text-truncate">25دقیقه</p>
												</div>
											</div>
			...
			<div class="col-lg-3">
				...
				<div class="row g-2 mt-2">
					...
					<div class="col-6 col-sm-4 col-md-3 col-lg-6">
						<a href="#"> <img src="courses/assets/images/client/google-play.svg" alt=""> </a>
					</div>
					<!-- App store button -->
					<div class="col-6 col-sm-4 col-md-3 col-lg-6">
						<a href="#"> <img src="courses/assets/images/client/app-store.svg" alt="app-store"> </a>
					</div>
				</div> <!-- Row END -->
			</div> 
			<!-- Widget 3 END -->
		...
		<div class="modal-content">
			...
			<div class="modal-body px-5 pb-5 position-relative overflow-hidden">
				...
				<figure class="position-absolute bottom-0 end-0 mb-n4 me-n4 d-none d-sm-block">
					<img src="courses/assets/images/element/01.svg" alt="element">
				</figure>
...
<script src="courses/assets/vendor/plyr/plyr.js"></script>
