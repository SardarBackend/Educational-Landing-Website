	...
	<nav class="navbar navbar-expand-xl">
        ...
        <!-- Nav Main menu START -->
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					<!-- Nav item 1 Demos -->
					<li class="nav-item ">
						<a class="nav-link " href="#" id="demoMenu"  aria-expanded="false">صفحه اصلی</a>
					</li>
					<li class="nav-item ">
						<a class="nav-link " href="#" id="demoMenu"  aria-expanded="false">صفحه اصلی</a>
					</li>
					...
					<li>
						<div class="bg-light dark-mode-switch theme-icon-active d-flex align-items-center p-1 rounded mt-2">
							<button type="button" class="btn btn-sm mb-0" data-bs-theme-value="light">
								<svg style="transform: scale(-1,1)" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sun fa-fw mode-switch" viewBox="0 0 16 16">
							...
							<button type="button" class="btn btn-sm mb-0" data-bs-theme-value="dark">
								<svg style="transform: scale(-1,1)" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-stars fa-fw mode-switch" viewBox="0 0 16 16">
							...
							<button type="button" class="btn btn-sm mb-0 active" data-bs-theme-value="auto">
								<svg style="transform: scale(-1,1)" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-circle-half fa-fw mode-switch" viewBox="0 0 16 16">
	...
	<div class="container position-relative">
		<div class="row g-4 align-items-center">
			<div class="col-md-6">
				...
				<!-- Button -->
				<a href="#fill-instructor-form" class="btn btn-primary mb-0">ثبت نام</a>
			</div>

			<div class="col-md-6 text-center">
				<!-- Image -->
				<img src="courses/assets/images/element/04.svg" class="h-300px h-xl-400px" alt="">
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="row g-4 g-md-5">
			...
			<div class="col-md-4 text-center">
				<img src="courses/assets/images/element/create-account.svg" class="h-200px" alt="">
				<h4 class="mt-3 ff-vb fs-5">ثبت نام</h4>
				<p class="text-truncate-2 mb-0">چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
			</div>

			<!-- Item -->
			<div class="col-md-4 text-center">
				<img src="courses/assets/images/element/add-course.svg" class="h-200px" alt="">
				<h4 class="mt-3 ff-vb fs-5">افزودن دوره</h4>
				<p class="text-truncate-2 mb-0">چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. 
				</p>
			</div>

			<!-- Item -->
			<div class="col-md-4 text-center">
				<img src="courses/assets/images/element/earn-money.svg" class="h-200px" alt="">
				<h4 class="mt-3 ff-vb fs-5">درآمدزدایی</h4>
				<p class="text-truncate-2 mb-0">چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
			</div>
		</div> <!-- Row END -->
	</div>
	...
	<div class="container">
		<div class="bg-orange bg-opacity-10 p-4 p-sm-5 rounded position-relative overflow-hidden">
			...
			<figure class="position-absolute top-50 end-0 translate-middle-y me-n7">
				<svg style="transform: scale(-1,1)" class="fill-white opacity-8 rotate-193" width="676px" height="161.3px" viewBox="0 0 676 161.3" style="enable-background:new 0 0 676 161.3;" xml:space="preserve">
			...
			<div class="row g-4 position-relative align-items-center justify-content-center">
				...
				<div class="col-sm-6 col-lg-3 text-center">
					...
					<h6 class="mb-0 fw-bold">تعداد دانشجویان</h6>
				</div>
				...
				<div class="col-sm-6 col-lg-3 text-center">
					...
					<h6 class="mb-0 fw-bold">تعداد مدرسان</h6>
				</div>
				...
				<div class="col-sm-6 col-lg-3 text-center">
					...
					<h6 class="mb-0 fw-bold">تعداد دوره ها</h6>
				</div>
          ...
          <svg style="transform: scale(-1,1)"	width="192.5px" height="89.4px" viewBox="0 0 192.5 89.4">
            <path class="fill-warning" d="M170.2,0.5c-0.1,0-0.2,0-0.4,0c-2.6-0.1-5.2-0.4-7.8-0.5c-2.9-0.1-5.8,0-8.6,0.2c-1.4,0.1-2.9,0.3-4.3,0.5 c-0.5,0.1-1,0-1.5,0c-1-0.1-1.9,0.2-2.9,0.3c-5.6,0.9-11.1,2.1-16.5,3.6c-2.7,0.7-5.4,1.6-8.1,2.5c-0.6,0.2-1.2,0.4-1.8,0.5 c-0.4,0-0.8,0-1.2,0.1c-1.5,0.2-3,1.1-4.3,1.8c-3,1.5-5.9,3.2-8.6,5.2c-2,1.5-3.8,3.1-5.6,4.8c-0.9,0.9-1.7,1.8-2.5,2.7 c-0.4,0.4-1.1,0.7-1.4,1.2c-0.3,0.4-0.6,0.9-0.9,1.4c-0.9,1.2-1.7,2.3-2.7,3.4c-0.3,0.4-0.7,0.6-1.2,0.6c-1.4,0.1-2.8-0.1-4.2-0.1 c-0.7,0-1.2,0.2-1.9,0.2c-3.3,0.4-6.6,0.7-9.8,1.6c-1.7,0.5-3.4,0.9-5.1,1.4c-5.4,1.5-11,2.9-16,5.4c-4.6,2.2-8.7,5.2-12.7,8.3 c-2,1.6-4,3.2-5.9,4.9c-0.8,0.7-1.6,1.2-2.5,1.6c-0.9,0.5-1.7,1.3-2.4,2c-1.4,1.3-2.9,2.6-4.3,3.9c-1.2,1.1-2.5,2.1-3.6,3.3 c-0.9,1-2,1.9-3,2.8c-1,0.9-2.1,1.9-3.1,2.8c-0.8,0.7-1.6,1.2-2.3,1.9c-0.9,0.9-1.7,1.9-2.7,2.7c0-0.7,0.2-1.3,0.2-2 c0-1.8-0.2-3.7-0.7-5.5c-0.2-0.9-0.5-1.8-1.1-2.4c-0.6-0.7-1.7-1-2.4-0.6c-0.1,0.1-0.3,0.2-0.4,0.3c-0.1,0.2-0.1,0.4,0,0.6 c0.7,3.7,1.2,7.4,0.7,11.1c-0.2,2.4-0.9,4.9-2,7c-0.5,1-1.2,1.9-1.7,3c-0.4,1-1.4,1.8-2.1,2.7C0.3,86,0.1,86.3,0,86.6 c-0.1,0.4,0.1,0.7,0.2,1.1c0.3,0.8,0.8,1.6,1.6,1.7c0.5,0,0.9-0.2,1.3-0.5c0.9-0.5,1.7-1.1,2.6-1.6c0.4-0.2,0.7-0.5,1.1-0.7 c1.7-1.3,3.7-2.3,5.7-3.1c4.3-1.7,9.1-2.4,13.8-1.7c0.2,0,0.4,0.1,0.7,0c0.7-0.2,0.9-1.2,0.4-1.8c-0.4-0.6-1.2-0.8-1.9-1 c-2.7-0.8-5.4-1.5-8.2-1.8c-0.7-0.1-1.4-0.1-2.1-0.2c-0.3,0-0.6,0-0.8,0c-0.3,0-0.9,0.2-1.2,0.1C13,77,13,77.1,13,76.8 
				...
				<div class="card card-body shadow p-4">
					<!-- Title -->
					<h3 class="fs-4">ارسال رزومه</h3>
					<!-- Form START -->
					<form class="row g-3 mt-2 position-relative z-index-9">
						<!-- Name -->
						<div class="col-lg-6">
							<label class="form-label">نام *</label>
							<input type="text" class="form-control" aria-label="نام و نام خانوادگی">
						</div>
						<!-- Email -->
						<div class="col-lg-6">
						...
						<!-- Button -->
						<div class="col-12">
							<button type="submit" class="btn btn-primary mb-0">ارسال</button>
						</div>
					</form>
					<!-- Form END -->
				</div>
			...
			<div class="col-lg-7 z-index-9 mt-5 mt-xl-0">
				<h3 class="fs-4">مراحل جذب مدرس</h3>
					<ul class="nav nav-pills nav-pill-soft my-4" id="course-pills-tab" role="tablist">
						...
						<li class="nav-item me-2 me-lg-4" role="presentation">
							<button class="nav-link mb-2 mb-xl-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">ثبت نام</button>
						</li>
						<!-- Tab item -->
						<li class="nav-item me-2 me-lg-4" role="presentation">
							<button class="nav-link mb-2 mb-xl-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-2" type="button" role="tab" aria-controls="course-pills-2" aria-selected="false">افزودن دوره</button>
						</li>
						<!-- Tab item -->
						<li class="nav-item me-2 me-lg-4" role="presentation">
							<button class="nav-link mb-2 mb-xl-0" id="course-pills-tab-3" data-bs-toggle="pill" data-bs-target="#course-pills-3" type="button" role="tab" aria-controls="course-pills-3" aria-selected="false">درآمدزدایی</button>
						</li>
					</ul>
					...
					<div class="tab-content" id="pills-tabContent">
						...
						<div class="tab-pane fade" id="course-pills-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
							...
							<ul class="list-group list-group-borderless mb-3">
								<li class="list-group-item">
									<i class="fas fa-check-circle text-success me-2"></i>کاربردهای متنوع با هدف بهبود ابزارهای کاربردی
								</li>
								<li class="list-group-item d-flex">
									<i class="fas fa-check-circle text-success me-2 mt-1"></i>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ
								</li>
								<li class="list-group-item">
									<i class="fas fa-check-circle text-success me-2"></i>طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو
								</li>
							</ul>
						</div>
						...
						<div class="tab-pane fade" id="course-pills-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
							<h6>درآمدزدایی</h6>
								...
								<img src="courses/assets/images/element/instructor-course.svg" class="rounded float-start me-3 h-200px my-3" alt="..."> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت 
...
<section class="pt-0">
	<div class="container position-relative">
		...
		<figure class="position-absolute top-50 start-50 translate-middle ps-3">
			<svg style="transform: scale(-1,1)" class="fill-white opacity-2">
				...
				<div class="col-11 position-relative">
					<div class="row align-items-center">
						...
						<div class="col-lg-7">
							...
							<p class="text-white mb-3 mb-lg-0">چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
						</div>
						<!-- Button -->
						<div class="col-lg-5 text-lg-end">
							<a href="#fill-instructor-form" class="btn btn-lg btn-white mb-0">ثبت نام</a>
						</div>
					</div>
				</div>
			</div>
...
<!-- Vendors -->
<script src="courses/assets/vendor/purecounterjs/dist/purecounter_vanilla.js"></script>
